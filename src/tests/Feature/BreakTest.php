...
class BreakTest extends TestCase
{
    ...
    public function test_button_breaking_start()
    {
        ...
        $response = $this->post('/stamp/break/start');
    ...
    public function test_breaking_start_repeat()
    {
        ...
        $response = $this->post('/stamp/break/stop');

        $response = $this->get('/attendance');
        $response->assertStatus(200);

        $response->assertSee('<form action="/stamp/break/start"', false);
    }
    ...
    public function test_breaking_list_view()
    {
        ...
        $date = $now_start->toDateString();
        $time = $now_start->toTimeString();

        $response = $this->post('/stamp/break/start');

        $now_stop = new CarbonImmutable('2026-02-02T02:00:00+09:00');
        CarbonImmutable::setTestNow($now_stop);
        $date = $now_stop->toDateString();
        $time = $now_stop->toTimeString();
