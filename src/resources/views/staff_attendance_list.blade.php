    ...
    <div class="main__inner">
        ...
        <div class="month">
            <div class="month-before">
                <a href="/admin/attendance/staff/{{ $user->id }}?month={{ $link_day_before }}" class="month-before__link">
            ...
            <div class="month-after">
                <a href="/admin/attendance/staff/{{ $user->id }}?month={{ $link_day_after }}" class="month-after__link">翌月
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td class="td">
                    <a class="td-detail" href="{{ route('admin.attendance.detail', ['id' => $work->id]) }}" class="item-link">詳細
                    </a>
                </td>
            </tr>
            @endforeach
